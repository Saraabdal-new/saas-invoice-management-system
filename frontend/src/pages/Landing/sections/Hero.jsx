...
export default function Hero({ scrollToAuth }) {
  return (
    <section className="relative z-10 pt-20 pb-32 px-6 text-center">
      <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-linear-to-r from-amber-400 via-yellow-500 to-amber-400 bg-clip-text text-transparent">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4">
        <button onClick={scrollToAuth} className="bg-linear-to-r from-amber-400 to-yellow-600 hover:from-amber-500 hover:to-yellow-700 text-black h-14 px-8 text-lg flex items-center justify-center gap-2 rounded shadow-lg">
