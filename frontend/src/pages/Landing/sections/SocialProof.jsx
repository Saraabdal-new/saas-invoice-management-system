export default function SocialProof({ testimonials }) {
    return (
      <section className="py-20 px-6 max-w-7xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-12 bg-gradient-to-r from-amber-400 to-yellow-600 bg-clip-text text-transparent">Trusted by 5,000+ users worldwide</h2>
