  ...
  return (
    <section className="relative z-10 py-20 px-6">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-12 bg-gradient-to-r from-amber-400 to-yellow-600 bg-clip-text text-transparent">Everything You Need</h2>
          ...
          {features.map((feature, idx) => {
            ...
            return (
              <Card key={idx} className="border-amber-500/20 bg-black/40 backdrop-blur-xl hover:bg-black/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-amber-500/20">
                <CardHeader>
                  <div className="w-12 h-12 bg-gradient-to-br from-amber-400 to-yellow-600 rounded-xl flex items-center justify-center mb-4 shadow-lg shadow-amber-500/50">
